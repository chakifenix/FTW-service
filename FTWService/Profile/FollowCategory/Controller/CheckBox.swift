...
//  OrzuServiceProject
//
//  Created by Zhanibek Santay on 2/9/20.
...
open class CheckBox: UIControl {
    ...
    @IBInspectable
    var uncheckedBorderColor: UIColor = #colorLiteral(red: 0.9960784314, green: 0.5490196078, blue: 0, alpha: 1)
    
    @IBInspectable
    var checkedBorderColor: UIColor = #colorLiteral(red: 0.9960784314, green: 0.5490196078, blue: 0, alpha: 1)
    
    @IBInspectable
    var checkmarkColor: UIColor = #colorLiteral(red: 0.9960784314, green: 0.5490196078, blue: 0, alpha: 1)
