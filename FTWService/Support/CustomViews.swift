...
public class KGRadioButton: UIButton {
    ...
    @IBInspectable public var outerCircleColor: UIColor = Data_Colors.gradientColor {
        didSet {
            outerCircleLayer.strokeColor = outerCircleColor.cgColor
        }
    }
    @IBInspectable public var innerCircleCircleColor: UIColor =  Data_Colors.gradientColor{
        didSet {
            setFillState()
        }
    }
